...
ui_ImageCameraShotImage = lv_img_create(ui_ScreenCameraShot);
lv_obj_set_height( ui_ImageCameraShotImage, 900);
lv_obj_set_width( ui_ImageCameraShotImage, lv_pct(100));
...
ui_PanelCameraShotControl = lv_obj_create(ui_ScreenCameraShot);
lv_obj_set_height( ui_PanelCameraShotControl, 236);
lv_obj_set_width( ui_PanelCameraShotControl, lv_pct(100));
lv_obj_set_align( ui_PanelCameraShotControl, LV_ALIGN_CENTER );
lv_obj_clear_flag( ui_PanelCameraShotControl, LV_OBJ_FLAG_SCROLLABLE );    /// Flags
lv_obj_set_style_bg_color(ui_PanelCameraShotControl, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT );
lv_obj_set_style_bg_opa(ui_PanelCameraShotControl, 0, LV_PART_MAIN| LV_STATE_DEFAULT);
lv_obj_set_style_border_width(ui_PanelCameraShotControl, 0, LV_PART_MAIN| LV_STATE_DEFAULT);
lv_obj_set_style_pad_left(ui_PanelCameraShotControl, 0, LV_PART_MAIN| LV_STATE_DEFAULT);
lv_obj_set_style_pad_right(ui_PanelCameraShotControl, 0, LV_PART_MAIN| LV_STATE_DEFAULT);
lv_obj_set_style_pad_top(ui_PanelCameraShotControl, 0, LV_PART_MAIN| LV_STATE_DEFAULT);
lv_obj_set_style_pad_bottom(ui_PanelCameraShotControl, 0, LV_PART_MAIN| LV_STATE_DEFAULT);
lv_obj_set_style_pad_row(ui_PanelCameraShotControl, 0, LV_PART_MAIN| LV_STATE_DEFAULT);
lv_obj_set_style_pad_column(ui_PanelCameraShotControl, 0, LV_PART_MAIN| LV_STATE_DEFAULT);

ui_PanelCameraShotControlBg = lv_obj_create(ui_PanelCameraShotControl);
lv_obj_set_width( ui_PanelCameraShotControlBg, 140);
lv_obj_set_height( ui_PanelCameraShotControlBg, 140);
lv_obj_set_align( ui_PanelCameraShotControlBg, LV_ALIGN_CENTER );
...
ui_ButtonCameraShotBtn = lv_btn_create(ui_PanelCameraShotControl);
lv_obj_set_width( ui_ButtonCameraShotBtn, 100);
lv_obj_set_height( ui_ButtonCameraShotBtn, 100);
lv_obj_set_align( ui_ButtonCameraShotBtn, LV_ALIGN_CENTER );
...
ui_PanelCameraShotAlbum = lv_obj_create(ui_PanelCameraShotControl);
lv_obj_set_width( ui_PanelCameraShotAlbum, 150);
lv_obj_set_height( ui_PanelCameraShotAlbum, 150);
lv_obj_set_x( ui_PanelCameraShotAlbum, 50 );
lv_obj_set_y( ui_PanelCameraShotAlbum, 0 );
lv_obj_set_align( ui_PanelCameraShotAlbum, LV_ALIGN_LEFT_MID );
